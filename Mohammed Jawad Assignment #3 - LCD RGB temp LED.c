 ...
 ******************************************************************************
 *  FILE          : main.c
 *  PROJECT       : Assignment #3 - LCD RGB temp LED
 *  PROGRAMMER    : Mohammed Jawad Jaber
 *  Student #     : 8741564
 *  FIRST VERSION : 2021-07-24
...
void setRGBColorForTim1Ch1to4(uint8_t red, uint8_t blue, uint8_t green,uint8_t white);
...
void setRGBColorForTim1Ch1to3(uint8_t red, uint8_t blue, uint8_t green){
	...
	__HAL_TIM_SetCompare(&htim1, TIM_CHANNEL_4, map(white, 0, 255, 9090, 0));
...
int main(void){
	...
	while (1)
	{
		...
		if(temp_celsius<-15)
		{
		    setRGBColorForTim1Ch1to3(255,255,255); 		//White
				}
